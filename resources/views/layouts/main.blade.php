...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" class="brand-link text-decoration-none">
            <span class="brand-text font-weight-light h2 text-light font-weight-bold ms-3">Золото Юга</span>
        </a>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; {{ now()->year }} <a href="{{ url('/') }}">Золото Юга</a>.</strong>
