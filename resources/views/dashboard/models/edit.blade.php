    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Редактирование модели автомобиля</h3>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('dashboard.models.update', $model) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="generation" id="generation" class="form-control" value="{{ old('generation', $model->generation) }}" placeholder="Например: Mk1, I, 1-е поколение">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="start_year" id="start_year" class="form-control" 
                            value="{{ old('start_year', $model->start_year) }}" min="1900" max="{{ date('Y') + 1 }}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="end_year" id="end_year" class="form-control" 
                            value="{{ old('end_year', $model->end_year) }}" min="1900" max="{{ date('Y') + 10 }}"
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_facelift" id="is_facelift" value="1" 
                                {{ old('is_facelift', $model->is_facelift) ? 'checked' : '' }}>
                    ...
                    <!-- Год рестайлинга -->
                    <div class="mb-3" id="facelift_year_container" style="{{ old('is_facelift', $model->is_facelift) ? '' : 'display: none;' }}">
                        ...
                        <input type="number" name="facelift_year" id="facelift_year" class="form-control" 
                            value="{{ old('facelift_year', $model->facelift_year) }}" min="1900" max="{{ date('Y') + 1 }}">
                    </div>
